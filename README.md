# Useful linux scripts and programs
...
Just assign the keyboard shortcut for the [script](../linux-useful/rotate-screen-180/rotate-screen.sh) in your window manager


### Firefox smooth scrolling
Firefox scrolling isn't really smooth with touchpads on X. These settings will make it a little bit better

[install](../linux-useful/firefox-smooth-scrolling/install.sh)
